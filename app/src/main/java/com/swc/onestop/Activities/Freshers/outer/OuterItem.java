package com.swc.onestop.Activities.Freshers.outer;
...
import com.swc.onestop.Activities.Freshers.inner.InnerAdapter;
...
//                .into(mAvatar);
        ...
        mHeaderCaption1.setSingleLine(false);
        mHeaderCaption1.setText(title1);
        //mHeaderCaption2.setText(title2);

        mInfo.setText(String.format("%s ", header.name));
      //  mName.setText(String.format("%s %s · %s", header.age, context.getString(R.string.years), header.address));
    }
...
//        ViewCompat.setAlpha(mMiddleAnswer, 0.5f - answerRatio);
        ...
        ViewCompat.setAlpha(mHeaderCaption1, 1f);
