...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.swc.onestop.Activities.Freshers.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.swc.onestop.Activities.Freshers.utils.GlideOptions().apply(toSet));
    }
  }
}
