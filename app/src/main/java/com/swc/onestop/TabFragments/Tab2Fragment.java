...
public class Tab2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myDataset.add(new FragmentMenu(getResources().getDrawable(R.drawable.e_rickshaw_illustration_small) ,
                "E-Rickshaw" ,
                "Fast In-campus transport","Transport"));

        myDataset.add(new FragmentMenu(getResources().getDrawable(R.drawable.book_cab_illustration_small) ,
                "Taxi" ,
