...
public class Outlook_API_Activity extends AppCompatActivity {
    ...
    private String[] hostelList={"Lohit","Barak","Umiam","Dihing","Siang","Manas","Kameng","Brahmaputra","Dibang","Kapili","Dhansiri","Subansiri","MSH","Staff/Faculty"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isOnline())
            showDialogBox(Outlook_API_Activity.this);
...
//        Toast.makeText(getApplicationContext(),"HELLO",Toast.LENGTH_SHORT).show();
    ...
    public void showDialogBox(Activity activity) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Outlook_API_Activity.this, "Connect to the Internet to Login.", Toast.LENGTH_SHORT).show();
                finish();
                dialog.cancel();
            }
        });
